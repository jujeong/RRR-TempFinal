package com.example.subwayjpgsqluse.model;
...
public final class Alarm implements Parcelable {
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeString(mStationSelect);
    }
    ...
    public void setStationSelect(String stationSelect) {
        this.mStationSelect = stationSelect;
    }

    public String getStationSelect() {
        return mStationSelect;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + mStationSelect.hashCode();
        return result;
    }

package com.example.subwayjpgsqluse.util;

import static com.example.subwayjpgsqluse.data.DatabaseHelper.COL_FRI;
import static com.example.subwayjpgsqluse.data.DatabaseHelper.COL_IS_ENABLED;
import static com.example.subwayjpgsqluse.data.DatabaseHelper.COL_LABEL;
import static com.example.subwayjpgsqluse.data.DatabaseHelper.COL_MON;
import static com.example.subwayjpgsqluse.data.DatabaseHelper.COL_SAT;
import static com.example.subwayjpgsqluse.data.DatabaseHelper.COL_STATION_SELECT;
import static com.example.subwayjpgsqluse.data.DatabaseHelper.COL_SUN;
import static com.example.subwayjpgsqluse.data.DatabaseHelper.COL_THURS;
import static com.example.subwayjpgsqluse.data.DatabaseHelper.COL_TIME;
import static com.example.subwayjpgsqluse.data.DatabaseHelper.COL_TUES;
import static com.example.subwayjpgsqluse.data.DatabaseHelper.COL_WED;
import static com.example.subwayjpgsqluse.data.DatabaseHelper._ID;
...
public final class AlarmUtils {
    ...
    public static ContentValues toContentValues(Alarm alarm) {
        ...
        cv.put(COL_STATION_SELECT, alarm.getStationSelect());
    ...
    public static ArrayList<Alarm> buildAlarmList(Cursor c) {
        ...
        if (c.moveToFirst()){
            do {
                ...
                final String stationSelect = c.getString(c.getColumnIndex(COL_STATION_SELECT));
                ...
                alarm.setStationSelect(stationSelect);

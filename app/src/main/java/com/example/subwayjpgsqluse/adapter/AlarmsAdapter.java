package com.example.subwayjpgsqluse.adapter;
...
import com.example.subwayjpgsqluse.ui.AddEditAlarmActivity;
...
public final class AlarmsAdapter extends RecyclerView.Adapter<AlarmsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(mAccentColor == -1) {
            mAccentColor = ContextCompat.getColor(c, R.color.purple_200);
        }
        ...
        holder.label.setText(alarm.getStationSelect());
